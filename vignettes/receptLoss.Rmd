...
devtools::install_github("dpique/receptLoss", build_opts=c("--no-resave-data", "--no-manual"), build_vignettes=TRUE)

vignette("receptLoss") #display this same vignette locally
```
